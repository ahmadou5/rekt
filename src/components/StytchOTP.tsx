        ...
        {step === "verify" && (
          <>
            ...
            <div className="w-[96%] ml-auto mr-auto mt-12">
              ...
              >
                {/* Digit Input Boxes */}
                <div className="flex justify-center mb-9 lg:gap-3 gap-3">
                  {code.map((digit, index) => (
                    <input
                      ...
                      className="w-12 h-12 lg:w-14 lg:h-14 text-center text-white text-xl font-medium bg-gray-900 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                      autoComplete="off"
