// components/SignUpErrorBoundary.tsx
        ...
        <div className="flex items-center justify-center flex-col h-screen w-full px-4 bg-gray-900 text-white">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-gray-300 mb-6">
              Something went wrong during the sign up process. This is usually
              temporary.
            </p>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded transition-colors duration-200"
              >
                Reload Page
              </button>
            </div>
            ...
            <div className="mt-6 text-sm text-gray-500">
              If this problem persists, please contact support or try signing up
              later.
            </div>
          </div>
        </div>
